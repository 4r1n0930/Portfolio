...
const PROJECTS = [
  {
    ...
    pic: 2,
    name: "Qubera",
    desc: "A cube-based 3D experience — geometry, motion and vibes rendered in the browser.",
    tags: ["three.js", "gsap"],
  ...
  },
  {
    ...
    pic: 3,
    name: "Impression",
    desc: "Pixel-perfect UI system that gives any screen a strong, lasting first impression.",
    tags: ["react", "vite"],
  ...
  },
  {
    ...
    pic: 4,
    name: "Systum",
    desc: "Backend brain — systemized APIs, clean architecture and sane data flow.",
  ...
  },
  {
    ...
    pic: 5,
    name: "KiranaGo",
    desc: "Local retail, digitized. Helping neighborhood shops go online in minutes.",
  ...
  },
  {
    ...
    pic: 6,
    name: "KisanSathi",
    desc: "Farmer-first tooling — market data and advisory served straight to the field.",
